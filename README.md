...
四大功能:
### Main Tool
<img src="demo/feature1.gif" width="80%"/><br>
此工具含四个选项: 预览文件夹内容, 预览重命名文件, 重命名文件, 刮削JAV信息. 注意事项如下:
...
### JavLibrary Manager
![jav manager demo](/demo/feature2.gif)
